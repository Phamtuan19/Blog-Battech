...
import NewItem from '~/component/customs/NewBannerItem'
    ...
    return (
        <div className=' lg:mt-[20px] md:mt-[80px] mt-[100px] flex flex-col '>
            ...
            <div className='lg:container max-auto w-full p-4 flex flex-col gap-y-20'>
                <div className=''>
                    <h3 className='text-xl font-bold not-italic text-[#444444]'>Tin tức mới</h3>
                    <div className='grid grid-cols-12 gap-7'>
                        <div className='lg:col-span-7 col-span-full'>
                            <div className='w-full h-[563px]'>
                                <NewItem
                        ...
                        <div className='lg:col-span-5 col-span-full h-auto flex flex-col gap-8 '>
                            <div className='w-full grid grid-cols-12 gap-y-7'>
                                <div className='col-span-full'>
                                    <div className='flex-1 lg:h-[265px] h-[563px]'>
                                        <NewItem

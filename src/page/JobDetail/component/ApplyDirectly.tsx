            ...
            <div className='mt-4 flex flex-col gap-y-4'>
                <form onSubmit={handleSubmit(handleSubmitForm)}>
                    ...
                    <div className='mb-3'>
                        ...
                        {errors && <span className='text-red-500 block'>{errors.cv?.message}</span>}
                    </div>
                    <div className='mb-3'>
                        <label htmlFor='name'>
                        ...
                        {errors && <span className='text-red-500 block'>{errors.address?.message}</span>}
                    </div>
                    <div className='mb-3'>
                        <label htmlFor='name'>
                        ...
                        {errors && <span className='text-red-500 block'>{errors.question?.message}</span>}
                    </div>
                    <div className='mb-3'>
                        <div className='flex items-center gap-3 border border-solid border-[#00000040] rounded-md px-3'>
                            <textarea cols={60} rows={10} {...register('note')} className='outline-none'></textarea>
                        </div>
                    </div>
                    <div className=''>
